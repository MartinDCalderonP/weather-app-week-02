...
export const weatherDataUrl = `https://api.allorigins.win/raw?url=https://www.metaweather.com/api/location/`;
export const searchInWeatherDataUrl = `search/?query=`;
export const defaultId = `2487956`;
